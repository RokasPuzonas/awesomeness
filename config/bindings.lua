...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ super,           }, "w", function () main_menu:show() end,
              {description = "show main menu", group = "awesome"}),
    awful.key({ super, "Control" }, "r", awesome.restart,
              {description = "reload awesome", group = "awesome"}),
    awful.key({ super, "Shift"   }, "q", awesome.quit,
              {description = "quit awesome", group = "awesome"}),
    awful.key({ super,           }, "Return", function () awful.spawn(config.terminal) end,
              {description = "open a terminal", group = "launcher"}),
    awful.key({ super }, "p", function() awful.spawn(config.program_launcher) end,
              {description = "program launcher", group = "launcher"}),
    awful.key({ super }, "q", function() awful.spawn(config.web_browser) end,
              {description = ("web browser '%s'"):format(config.web_browser), group = "launcher"}),
})
